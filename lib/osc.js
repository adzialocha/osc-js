(function (global, factory) {
  ...
  var Atomic = function (_Entity) {
    ...
    createClass(Atomic, [{
      key: 'pack',
      value: function pack(type, byteLength) {
      ...
      key: 'unpack',
      value: function unpack(dataView, type, byteLength, offset) {
  ...
  var AtomicInt32 = function (_Atomic) {
    ...
    createClass(AtomicInt32, [{
      ...
      key: 'unpack',
      value: function unpack(dataView, offset) {
        return get(AtomicInt32.prototype.__proto__ || Object.getPrototypeOf(AtomicInt32.prototype), 'unpack', this).call(this, dataView, 'getInt32', 4, offset);
      }
    }]);
    return AtomicInt32;
  }(Atomic);
  ...
  var AtomicFloat32 = function (_Atomic) {
    ...
    createClass(AtomicFloat32, [{
      ...
      key: 'unpack',
      value: function unpack(dataView, offset) {
        return get(AtomicFloat32.prototype.__proto__ || Object.getPrototypeOf(AtomicFloat32.prototype), 'unpack', this).call(this, dataView, 'getFloat32', 4, offset);
      }
    }]);
  ...
  var Bundle = function () {
    ...
    createClass(Bundle, [{
      ...
      value: function unpack(dataView, offset) {
        ...
        var end = head.unpack(dataView, offset);
  ...
  var Packet = function (_Entity) {
    ...
    createClass(Packet, [{
      ...
      key: 'unpack',
      value: function unpack(dataView, timetag) {
