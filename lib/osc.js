...
var STATUS$1 = {
  ...
  return Object.assign({}, defaultOptions$3, base, custom, {
    open: Object.assign({}, defaultOptions$3.open, base.open, custom.open),
    send: Object.assign({}, defaultOptions$3.send, base.send, custom.send)
  });
}
...
var WebsocketServerPlugin = function () {
  function WebsocketServerPlugin(customOptions) {
    ...
    this.options = Object.assign({}, defaultOptions$6, customOptions);
    this.socket = null;
